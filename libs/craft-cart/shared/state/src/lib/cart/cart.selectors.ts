...
const { selectAll, selectEntities, selectTotal } = cartAdapter.getSelectors();
...
export const selectCartTotal = createSelector(selectCartState, (state: CartState) => selectTotal(state));
